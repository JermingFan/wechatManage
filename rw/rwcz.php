...
$getuid = $_GET['uid'];
$sql = "SELECT * FROM `user_renwu` WHERE `uid` = '$getuid'";
...
<div class="container">
    <form action="http://wglpt.sinaapp.com/rw/rwcz.php" method="post">
        <h2 class="form-signin-heading">请修改任务状态</h2>
        ...
        <div class="form-group">
            ...
            <select name="state" class="form-control">
                <option value="0" <?php if (0 == $rows['state']) echo 'selected' ?>>未完成</option>
                <option value="1" <?php if (1 == $rows['state']) echo 'selected' ?>>完成</option>
            </select>
        </div>
        <div class="form-group">
